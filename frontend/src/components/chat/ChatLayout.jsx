...
const DEMO_MESSAGES = {
  global: [
    { id: 1, sender: "STD25001", content: "Bonjour à tous !",                own: false, time: "09:00" },
    { id: 2, sender: "STD24001", content: "Salut ! Le TD de WEB2 c'est pour quand ?", own: false, time: "09:05" },
    { id: 3, sender: "Dr Toky",  content: "Pour vendredi prochain.",          own: false, time: "09:10" },
    { id: 4, sender: "Moi",      content: "Merci Dr Toky !",                 own: true,  time: "09:12" },
  ],
  "dr-toky": [
    { id: 1, sender: "Dr Toky", content: "Avez-vous des questions sur le cours ?", own: false, time: "10:00" },
  ],
};
